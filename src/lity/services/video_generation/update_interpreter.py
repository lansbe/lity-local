...
VIDEO_UPDATE_INTERPRETER_PROMPT = """Tu es un interprète d'intentions pour paramètres de génération vidéo.
Classe le message parmi :
- "update_video_params" avec "updates"
- "confirm_generation"
- "cancel_generation"
- "normal_message"

Clés autorisées dans updates : prompt, negative_prompt, width, height, num_frames, fps, steps, cfg_scale, sampler, seed, checkpoint.
Réponds uniquement en JSON valide.
"""


class VideoParamUpdateInterpreter:
    ...
    def interpret_correction(
        ...
        try:
            ...
            response = ollama.chat(
                ...
                messages=[
                    {"role": "system", "content": VIDEO_UPDATE_INTERPRETER_PROMPT},
            ...
            logger.warning("Video update interpretation fallback: %s", exc)
